...
const en = {
  ...
  inference: {
    ...
    oneTimeHelp: "Leave empty to ring the employee's mobile, or type another number for the next run only.",
...
const ar: Dict = {
  ...
  inference: {
    ...
    oneTimeNumber: "رقم لمرة واحدة",
    oneTimeHelp: "اتركه فارغًا ليُتصل بجوال الموظف، أو اكتب رقمًا آخر للتشغيل التالي فقط.",
